        ...
        <div class="nav-actions d-flex align-items-center gap-3 mt-3 mt-lg-0">
            ...
            <div class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end luxury-dropdown">
                  <li><a class="dropdown-item text-gold" href="myorder.php">Order History</a></li>
                  <li><a class="dropdown-item" href="my-appointments.php">My Sessions</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <!-- Using the existing ID to preserve myorder.js functionality -->
                  <li><a href="#" class="dropdown-item logout-link" id="myOrderLogout">Sign Out</a></li>
              </ul>
            </div>
        </div>
      </div>
